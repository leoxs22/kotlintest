  ...
  init {
    "The system properties function" - {
      "Must accept a suspend block" - {
        ...
        "Key Value overload" {
          withSystemProperty("Key", "Value", suspendBlock)
        }
  
        "List of Pair value overload" {
          withSystemProperties(listOf("Key" to "Value"), suspendBlock)
        }
  
        "Properties value overload" {
          withSystemProperties(Properties(), suspendBlock)
        }
  
        "Map value overload" {
          withSystemProperties(mapOf("Key" to "Value"), suspendBlock)
        }
      }
    }
  }
